...
public class ApplicationContext : DbContext
{
    ...
    public DbSet<PassportInformation> Passports { get; set; } = null!;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Transaction>().Property(t => t.TransactionId)
            .UseIdentityAlwaysColumn();
        modelBuilder.Entity<PassportInformation>().Property(p => p.PassportInformationId)
            .UseIdentityAlwaysColumn();
        modelBuilder.Entity<PassportInformation>().ToTable("PassportInformation");
