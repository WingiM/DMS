          ...
          <div className="resident-content">
              <form onSubmit={this.handleSubmit}>
                  <div className="resident-content-row">
                      <label>Фамилия:</label> <input name={"lastname"} onChange={this.handleChange} readOnly={this.props.readOnly} value={this.state.lastname} type="text"/> <br/>
                  </div>
                  <div className="resident-content-row">
                  ...
                  <div className="resident-content-row">
                      ...
                      <input id={"resident_gender_male" + this.state.id} type="radio" onChange={this.handleChange} readOnly={this.props.readOnly} checked={this.state.gender === 'M'}  name="gender" value={"М"}/>
