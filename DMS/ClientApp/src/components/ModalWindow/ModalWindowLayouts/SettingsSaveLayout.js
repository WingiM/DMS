        ...
        return (
            <div>
                ...
                <div className="settings-save-content">
                    ...
                    <input type="password" className={"password-repeat"} placeholder={"Введите пароль"}/>
                    ...
                    <div className="buttons-container">
                        ...
                        <button onClick={this.props.applyStats} className="settings-btn done">Применить</button>
                    </div>
                </div>
            </div>
        )
